...
public class HBComp extends Composite {
    private Text text;
     ...
     * @param style
     */
    public HBComp(Composite parent, int style) {
        super(parent, style);
        ...
        Label lblQuestion = new Label(this, SWT.NONE);
        lblQuestion.setText("Question 1");
        lblQuestion.setBounds(0, 35, 221, 41);
        ...
        label_8.setBounds(159, 268, 133, 32);
        
        Label lblQuestion_1 = new Label(this, SWT.NONE);
        lblQuestion_1.setText("Question 2");
        lblQuestion_1.setBounds(229, 35, 221, 41);
