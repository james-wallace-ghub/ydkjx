...
public class CCCOut extends YDKJQ {
	...
	int answer;
	public CCCOut(String wout, QHeader qh, String pal) throws IOException {
		...
		JackGraphic jgfx = QData.getGfx().get("off4_22500");

        jgfx.SetPalette(pal);
    	  File outputimage = new File(typegfx, 22500+".gif");
          ...
          try {
              File output = new File(typegfx, 22500+".json");
