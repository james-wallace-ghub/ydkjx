...
public class JackGraphicLegacy extends JackGraphic {
	...
	public JackGraphicLegacy(byte[] data,String palette) {
		visframes = new ArrayList<JackFrame>();
//		imagestart = (KSFLUtilities.getInt(data, 0));
		fpsnum = KSFLUtilities.getShort(data, 0);
		fpsden = KSFLUtilities.getShort(data, 2);
...
//		int altnumimages = KSFLUtilities.getShort(data,seekpos);
	...
	public JackGraphicLegacy(byte[] data) {
		this(data,"org/kjtw/resources/YDKJ2PAL.bmp");
	}

	public JackGraphicLegacy() {
		visframes = new ArrayList<JackFrame>();
		imagestart = 0;
		fpsnum = 0;
		fpsden = 0;
